...
def filter_tags(papers: List[Dict[str, str]], target_fileds: List[str]=["cond-mat", "quant-ph", "math-ph"]) -> List[Dict[str, str]]:
...
def back_up_files():
    # back up DailyPapers.md and ISSUE_TEMPLATE.md
    shutil.move("DailyPapers.md", "DailyPapers.md.bk")
    shutil.move(".github/ISSUE_TEMPLATE.md", ".github/ISSUE_TEMPLATE.md.bk")

def restore_files():
    # restore DailyPapers.md and ISSUE_TEMPLATE.md
    shutil.move("DailyPapers.md.bk", "DailyPapers.md")
    shutil.move(".github/ISSUE_TEMPLATE.md.bk", ".github/ISSUE_TEMPLATE.md")

def remove_backups():
    # remove DailyPapers.md and ISSUE_TEMPLATE.md
    os.remove("DailyPapers.md.bk")
